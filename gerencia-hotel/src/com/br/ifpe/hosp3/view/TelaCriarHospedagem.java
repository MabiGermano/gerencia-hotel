 ...
 * Classe de interface gr�fica para cria��o de hospedagem
 **/
public class TelaCriarHospedagem extends JInternalFrame {
	...
	/**
	 * M�todo de a��o na interface para cria��o de registro de hospedagem
	 * 
	 **/
	...
	/**
	 * M�todo de a��o para popular tabela e executar a��o ao selecionar hospede
	 * 
	...
	/**
	 * M�todo para listagem dos quartos dispon�veis e execu��o de a��o de sele��o de quarto
	 **/
	...
	/**
	 * M�todo de busca do hospede a partir do cpf digitado
	 * 

...
public class EnderecoDao implements ManipulacaoDeDados {
	...
	@Override
	/**
	 * M̩todo para alterar o objeto Endere̤o no banco de dados
	 * 
	 * @param object {@link Object}
	 **/
	...
	@Override
	/**
	 * M̩todo de listagem para todos os objetos 
	 * de Endere̤o no banco de dados
	 * 
	...
	@Override
	/**
	 * M̩todo para listar o objeto 
	 * Endere̤o no banco de dados por ID
	 * 
	 * @param id {@link int}
